...
function update_version
{
    ...
    current_version=$(grep -oiP '(?<=const Version = ")([a-zA-Z0-9\-.]+)(?=")' api/api.go)
    ...
    echo git add api/api.go CHANGELOG.md
    ...
    git add api/api.go CHANGELOG.md
